...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        sizePolicy.setHeightForWidth(self.comboBox_body_funcionario.sizePolicy().hasHeightForWidth())
        self.comboBox_body_funcionario.setSizePolicy(sizePolicy)
        font2 = QFont()
        ...
        self.pushButton_body_relatorio_anexar.setFont(font4)
        ...
        self.gridLayout_3.addWidget(self.frame, 11, 1, 1, 1)
        ...
        sizePolicy3.setHeightForWidth(self.pushButton_cadastros_visualizar.sizePolicy().hasHeightForWidth())
        self.pushButton_cadastros_visualizar.setSizePolicy(sizePolicy3)
        ...
        self.gridLayout_3.addWidget(self.frame_7, 11, 0, 1, 1)
